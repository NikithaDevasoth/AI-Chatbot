...
const Login = () => {
  ...
  return (
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4 m-auto  items-start p-8 py-12 w-80 sm:w-[352px] text-gray-500 rounded-lg shadow-xl border border-gray-200 bg-white">
        <p className="text-2xl font-medium mx-auto">
  ...
  <p>
    ...
    >
      Click here
        ...
        <button type='submit' className="bg-purple-700 hover:bg-purple-800 text-white w-full  py-2 rounded-md transition-all cursor-pointer">
